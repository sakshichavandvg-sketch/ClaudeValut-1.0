      ...
      <div className="section-container">
        ...
        <div className="features-grid">
          ...
          <div className="feature-card">
            ...
            <p>
              Create and edit documents with our rich text editor, similar to Google Docs.
            </p>
          </div>
          <div className="feature-card">
            <div className="feature-icon">
            ...
            <p>Your files are protected with enterprise-grade encryption.</p>
          </div>
          <div className="feature-card">
            <div className="feature-icon">
            ...
            <p>Star your most important files for quick access.</p>
          </div>
          <div className="feature-card">
            <div className="feature-icon">
              <svg width="32" height="32" viewBox="0 0 24 24" fill="#a142f4">
                <path d="M13 3c-4.97 0-9 4.03-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42C8.27 19.99 10.51 21 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9zm-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8H12z" />
              </svg>
            </div>
            <h3>Version History</h3>
            <p>Track changes and restore previous versions of files.</p>
          </div>
          <div className="feature-card">
            <div className="feature-icon">
              <svg width="32" height="32" viewBox="0 0 24 24" fill="#1a73e8">
            ...
            <p>Export documents to PDF, DOCX, and share via WhatsApp.</p>
          </div>
        </div>
      </div>
    </section>
